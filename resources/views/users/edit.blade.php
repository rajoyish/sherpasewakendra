<x-admin-layout>
    <div class="py-6">
        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 md:px-8">
            ...
            <main>
                <form method="POST" action="{{ route('users.update', $user) }}" class="space-y-8 divide-y divide-gray-200"
                    ...
                    <div>
                        ...
                        <div class="pt-5">
                            <div class="flex justify-end">
                                ...
                                <button type="submit"
                                    class="focus:ring-prime-blue ml-3 inline-flex justify-center rounded-md border border-transparent bg-prime-blue py-2 px-4 text-white shadow-sm hover:bg-ace-gold focus:outline-none focus:ring-2 focus:ring-offset-2">Update</button>
                            </div>
                        </div>
                </form>
            </main>
