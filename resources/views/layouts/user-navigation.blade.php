...
<div x-show="open" class="fixed inset-0 z-40 flex md:hidden"
    ...
    <div x-show="open" x-transition:enter="transition ease-in-out duration-300 transform"
         ...
         class="relative flex w-full max-w-xs flex-1 flex-col bg-monk-red pt-5 pb-4" style="display: none">
...
<div class="hidden md:fixed md:inset-y-0 md:flex md:w-64 md:flex-col">
    ...
    <div class="flex min-h-0 flex-1 flex-col bg-monk-red">
        <div class="flex h-16 flex-shrink-0 items-center bg-monk-red px-4">
            <x-cms-creator-logo/>
        </div>
