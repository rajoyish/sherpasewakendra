            ...
            <form class="flex w-full md:ml-0" action="#" method="GET">
                ...
                <div class="relative w-full text-gray-400 focus-within:text-gray-600">
                    ...
                    <input id="search-field"
                        class="block h-full w-full border-transparent py-2 pl-8 pr-3 text-gray-900 placeholder-gray-500 focus:border-transparent focus:placeholder-gray-400 focus:outline-none focus:ring-0 sm:"
            ...
            <div x-data="{ openProfile: false }" class="relative ml-3">
                <div>
                    <button x-on:click="openProfile = ! openProfile" type="button"
                        ...
                        <img class="h-8 w-8 rounded-full" src="{{ url('storage/'.Auth::user()->photo) }}" alt="" />
                    </button>
                </div>
                ...
                <div :class=" openProfile ? '' : 'hidden' " x-transition:enter="transition ease-out duration-100"
                    ...
                    <a href="/" class="block px-4 py-2 text-gray-700 hover:bg-gray-100" role="menuitem" tabindex="-1"
                        id="user-menu-item-1">Home</a>
